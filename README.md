...
Pages project: `dripnex-marketing` serves https://dripnex.app and https://www.dripnex.app (preview: https://dripnex-marketing.pages.dev).

`/docs` redirects to the docs site. Apex and www are attached to this project.
