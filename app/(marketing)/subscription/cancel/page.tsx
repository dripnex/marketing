...
import { Undo2, Download, Zap, Cloud, GitBranch, LinkIcon, Search } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 my-12">
          ...
          <div className="p-6 sm:p-8 rounded-xl bg-surface border border-accent/20 text-left">
            ...
            <p className="text-[#a1a1aa] mb-6">
              Pro includes cloud sync, backlinks, graph view, and advanced search. Don&apos;t Sync
