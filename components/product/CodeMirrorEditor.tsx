...
const theme = EditorView.theme(
  {
    ...
    '.cm-cursor': { borderLeftColor: '#fafafa', borderLeftWidth: '2px' },
    ...
    '.cm-tooltip-autocomplete li[aria-selected]': { backgroundColor: 'rgba(255,255,255,0.08)' },
    '.cm-completionDetail': { color: 'rgba(255,255,255,0.35)', marginLeft: '8px' },
  },
  { dark: true },
);
